...
optimizer_config = dict(grad_clip=dict(max_norm=35, norm_type=2), iter_size=iter_size)
# learning policy
lr_config = dict(
    policy='step',
    warmup='linear',
...
log_level = 'INFO'
work_dir = '../work_dirs/faster_rcnn_dhrnetv2p_w18_1x'
load_from = None
resume_from = None
workflow = [('train', 1)]
